...
import SubVentanas.frmConstancia;
 ...
 * @author Gabriela
 */
public class PanelContanciaInstancia {
    private static JFrame jf;
    
    public PanelContanciaInstancia(){
    ...
    public static JFrame getInstance(int tamanox,int tamanoy){
        ...
        if(jf==null){
            jf=new frmConstancia();
           PanelContanciaInstancia.ubicacionVentana(jf,tamanox,tamanoy);
       }else{
           jf.dispose();
          jf=new frmConstancia();
          PanelContanciaInstancia.ubicacionVentana(jf,tamanox,tamanoy);
