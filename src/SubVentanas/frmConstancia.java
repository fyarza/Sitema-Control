...
//      }
     ...
     private void limpiar()
  {
    ...
    lb_regimendepermanencia.setText("");
     ...
     private boolean calculo_estatus(int p,int a,int tipo)
  {
    ...
    { 
      ...
      if (rset.next())
      {
         ...
         // JOptionPane.showMessageDialog(this, periodo_actual);
     ...
     private String buscarrhp(String cedula, String codigo)
  {
    ...
    try
    {
      ...
      if (rset.next())
      {
        ...
        this.lb_estatus.setText(rset.getString("estatus"));
      }
      rset.close();
      conexion.close();
    }
      ...
      private void fecha_tesis(String alumno)
  {
    ...
    catch (SQLException exc)
    {
     ...
     return resul;
      ...
      private void deudaregimendepermanencia(int pi,int ai){
         int ano,periodo;
        String[] arraycursos = periodo_actual.split("-");
       // JOptionPane.showMessageDialog(this, periodo_actual);
          ano=Integer.parseInt(arraycursos[0]);
         ...
         if(pi>=periodo){
             int resul=(ano-ai)-1;
             if(resul>0){
                lb_regimendepermanencia.setText(resul+" años");    
             }else{
              lb_regimendepermanencia.setText("NO APLICA");
             }
         }else{
             int resul=ano-ai;
             if(resul>0){
    ...
    private void initComponents() {
        ...
        lb_regimendepermanencia = new javax.swing.JLabel();
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de Materia", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 12))); // NOI18N
        ...
        jPanel10.add(txt_asignaturaC);

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel10.setText("Creditos:");
        jPanel10.add(jLabel10);
        jPanel10.add(txt_creditosC);
        ...
        carga_manualLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel10, javax.swing.GroupLayout.DEFAULT_SIZE, 760, Short.MAX_VALUE)
        );
        carga_manualLayout.setVerticalGroup(
            carga_manualLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel10, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
        );
        ...
        ProrrogaLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel12, javax.swing.GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
        );
        ...
        lb_estatus.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jPanel1.add(lb_estatus);

        jLabel35.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel35.setText("REGIMEN DE PERMANENCIA");
        jPanel1.add(jLabel35);

        lb_regimendepermanencia.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jPanel1.add(lb_regimendepermanencia);
        ...
        tablamaterias.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void txt_cedulaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cedulaKeyTyped
        ...
        if (c==KeyEvent.VK_ENTER){
            if (cargarestudiante(this.txt_cedula.getText()))
            {
                ...
                ultimamateriavista(buscarrhp(this.txt_cedula.getText(), arraycursos[0]));
                ...
                int ano,periodo;
                 String[] arraycohorte = lb_cohorte.getText().split("-");
                 String[] arrayultimamateria = ultima_materia.split("-");
                ano=Integer.parseInt(arraycohorte[0]);
                periodo=Integer.parseInt(arraycohorte[1]);
                calculo_estatus(periodo,ano,t);
                ano=Integer.parseInt(arrayultimamateria[0]);
                periodo=Integer.parseInt(arrayultimamateria[1]);
                deudaregimendepermanencia(periodo,ano);
                
                }else{
                    System.out.println("COHORTE VACIA");
                }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (this.tablamaterias.getRowCount() != 0)
        {
            if(!lb_cohorte.getText().equals("")){
                ...
                //JOptionPane.showMessageDialog(this,calculo_estatus(periodo,ano,t) );
                if(calculo_estatus(periodo,ano,t)){
                    ...
                    map.put("estatus", this.lb_estatus.getText());
                    if (lb_nacionalidad.getText().equals("VENEZOLANO")){
                        nac="V-";
                    }else if (lb_nacionalidad.getText().equals("EXTRANJERO")){
                        nac="E-";
    ...
    private javax.swing.JLabel lb_regimendepermanencia;
