...
public class TextFooter {
    ...
    class MyFooter extends PdfPageEventHelper {
        Font ffont = new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD);
 
        public void onEndPage(PdfWriter writer, Document document) {
            PdfContentByte cb = writer.getDirectContent();
            Paragraph header = new Paragraph("Universidad de Carabobo Facultad de Ingeniería Dirección de Estudios para Graduados", ffont);
